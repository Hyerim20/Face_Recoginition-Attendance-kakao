...
imgElon = face_recognition.load_image_file('C:/Users/hyeri/Desktop/OSS/Face-Recognition-Attendance-Record-master/FaceFile/Elon Musk.jpg') #인코딩에 사용할 이미지 가져오기
imgElon = cv2.cvtColor(imgElon,cv2.COLOR_BGR2RGB)  #RGB로 변환
imgTest = face_recognition.load_image_file('C:/Users\hyeri\Desktop\OSS\Face-Recognition-Attendance-Record-master\FaceFile\kanghyerim.jpg')  #Test 이미지 가져오기
